...
public class KandangdComponetFormDefault extends ComponetFormAbstract {

	protected JTextField kandang;
	...
	public void setContentComponent(ODocument model) {
		if (modelIsTrue(model)) {
			...
			//retakkg.setText(kandangdModel.field(KandangdDao.retakkg) + "");
			...
			kandang.setText(model.field(KandangDao.name) + "");
		}
	}

	public void initComponent(ODatabaseDocumentTx db) {
		
		kandang= new JTextField();
		tgl= new JTextField();
	...
	public void buildForm(ODatabaseDocumentTx db) {
		...
		builder.append( KandangdDao.fhd, hd, 1, (i = i + 2), 5);
		builder.append( KandangdDao.fp, btr, 1, (i = i + 2), 5);
